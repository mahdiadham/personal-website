...
const PortfolioCard = ({ data }) => {
    ...
    return (
        <div className="min-w-67 max-w-67 xs:!min-w-85 xs:!max-w-85 h-130 max-xs:min-h-145 px-4 py-6 rounded-2xl flex flex-col justify-start items-start bg-gradient-to-bl from-[#151b29] to-[#0b0f19] transition hover:-translate-y-2 hover:border-teal-700 duration-300 text-white border border-slate-800 relative">
