const PortfolioCard = ({ data }) => {
    ...
    return (
        <div className="min-w-67 max-w-67 xs:!min-w-85 xs:!max-w-85 h-130 max-xs:!h-120 px-4 py-6 rounded-2xl flex flex-col justify-start items-start bg-gradient-to-bl from-[#151b29] to-[#0b0f19] transition hover:-translate-y-2 hover:border-teal-700 duration-300 text-white border border-slate-800 relative">
                        ...
                        <div className="w-full flex justify-between items-center mb-4">
                            <a href={link} className="z-90 border border-teal-500 text-teal-500 py-1.5 px-4 rounded-md transition-all duration-300 hover:-translate-y-1 capitalize">
                                view project
                            </a>
                            {github &&
                                <a href={github} className="z-90 border border-teal-500 text-teal-500 py-1.5 px-4 rounded-md transition-all duration-300 hover:-translate-y-1 capitalize">
                                    github repo
                                </a>
                            }
                        </div>
